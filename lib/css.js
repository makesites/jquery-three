...
fn.css = {
	...
	terrain: function( attr ){
		...
		var terrainScale = object._attributes.scale; // modified through an option
		var useShader = object._attributes.shader;
		//
		...
		if( !useShader ){
			// wait for ShaderTerrain to render...
			setTimeout(function(){
				//object.computeElevation();
			}, 5000);
		}
		/*
